            ...
            <table class="menu-container" border="0">
                            ...
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">
                                        <?php echo substr($correo_usuario,0,22) ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule">
                        <a href="cronograma.php" class="non-style-link-menu"><div><p class="menu-text">Cronograma</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="citas.php" class="non-style-link-menu"><div><p class="menu-text">Citas</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Busca a un doctor por su nombre o correo" list="doctors">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="doctors">';
                                $list11 = $bd->query("select  docname,docemail from  doctor;");
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Añadir doctor</p>
                    </td>
                    <td colspan="2">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="doctores.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Ver doctores &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                        ¿Estás seguro de que desea eliminar <br><b>'.substr($nameget,0,40).'</b> permanentemente? <br>
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="doctores.php" class="non-style-link"><button  class="btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Cancelar&nbsp;&nbsp;</font></button></a>
                        <a href="eliminar-doctor.php?id='.$id.'" class="non-style-link"><button class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Eliminar&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Añadir nuevo doctor</p><br><br>
                                </td>
                            </tr>
                            
                            <tr>
                                <form action="añadir-nuevo.php" method="POST" class="add-new-form">
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Nombre: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="Nombre del doctor" required><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="NSS" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="Número de teléfono" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="spec" id="" class="box" >';
                                        ...
                                        $list11 = $bd->query("select  * from  specialties order by sname asc;");
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="cpassword" class="input-text" placeholder="Confirmar la contraseña" required><br>
                                </td>
                            </tr>
            ...
            ';
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h3>¡Nuevo doctor añadido con éxito!</h3>
                                <a class="close" href="doctores.php">&times;</a>
                                <div class="content">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Editar información del doctor</p>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="name" class="input-text" placeholder="Nombre del doctor" value="'.$name.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Elige una especialidad: (Current'.$spcil_name.')</label>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Ingresa una contraseña" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Confirmar contraseña: </label>
            ...
            echo '
                <div id="popup1" class="overlay">
                    <div class="popup">
                        <center>
                        <br><br><br><br>
                            <h2>¡Editado con éxito!</h2>
                            <a class="close" href="doctores.php">&times;</a> 
                            <div class="content">
                                Se han editado correctamente los datos
                            </div>
                            <br><br>
                        </center>
                    </div> 
