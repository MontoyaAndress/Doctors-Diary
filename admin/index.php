            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active" >
                        <a href="index.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Panel</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctores.php" method="post" class="header-search">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Próximas sesiones hasta el siguiente <?php
                                        include('../fecha-es.php');
                                        echo fechaEs(date("l",strtotime("+1 week")));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Acceso rápido a las citas de los próximos 7 días.<br>
                                    Más detalles disponibles en la sección Cronograma.
                                    </p>
                                ...
                                <td>
                                    ...
                                    Acceso rápido a las próximas sesiones programadas hasta<br> dentro de 7 días.
                                    Añadir, eliminar y otras funciones disponibles en la sección Cronograma.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today'  and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="citas.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todas las reservaciones &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No pudimos encontrar nada relacionado con sus palabras clave</p>
                                                    <a class="non-style-link" href="cronograma.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todas las citas &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="citas.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ver reservaciones</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="cronograma.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ver citas</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
