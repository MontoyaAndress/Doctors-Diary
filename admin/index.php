                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Próximas citas hasta el siguiente <?php
                                ...
                                <td>
                                    ...
                                    Sesiones hasta el siguiente <?php  
                                        echo fechaEs(date("l",strtotime("+1 week")));
                                        ?>
                                    </p>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="citas.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ver citas</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="cronograma.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ver reservaciones</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
