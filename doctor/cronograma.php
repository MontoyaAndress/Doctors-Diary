     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                     <a href="cronograma.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Mis sesiones</p></div></a>
                 </td>
             </tr>
             <tr class="menu-row" >
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $bd->query("select  * from  schedule where docid=$userid;");
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                               ...
                               Número máximo de reservaciones
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="cronograma.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar sesiones &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Doctor en la sesión: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Hora de inicio: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                ...
                                <center>
                                 ...
                                 <tbody>';
                                         ...
                                         if($result->num_rows==0){
                                             ...
                                             <br>
                                             <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No encontramos nada!</p>
