...
<body>
    ...
    $userrow = $bd->query ("select * from patient where pemail='$useremail'");
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                        <a href="cronograma.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Reservaciones</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Buscar nombre del doctor, correo o fecha (D-M-A)" list="doctors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
                                        
                                        <?php
                                            echo '<datalist id="doctors">';
                                            $list11 = $bd->query("select DISTINCT * from  doctor;");
                                            $list12 = $bd->query("select DISTINCT * from  schedule GROUP BY title;");
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="cronograma.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todas las sesiones &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h4-search">
                                                                '.$scheduledate.'<br>Inicia: <b>'.substr($scheduletime,0,5).'</b> (24h)
                                                            </div>
                                                            <br>
                                                            <a href="reserva.php?id='.$scheduleid.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Reservar ahora</font></button></a>
                                                    </div>
