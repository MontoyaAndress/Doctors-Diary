                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="cronograma.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Contactar a un doctor &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
