        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="eliminar-cuenta.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Borrar&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Nacimiento: </label>
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="ajustes.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Editar información de tu cuenta.</p>
                                        Paciente ID : '.$id.' (Generado automáticamente)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="editar-usuario.php" method="POST" class="add-new-form">
                                            <label for="Email" class="form-label">Correo: </label>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="ajustes.php">&times;</a>
                            <div class="content">
                               Si cambias tu correo vuelve a iniciar sesión
                                
                            </div>
                            <div style="display: flex;justify-content: center;">
                            
                            <a href="ajustes.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
