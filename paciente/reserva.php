     ...
     <table class="menu-container" border="0">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="cronograma.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td >
                            <form action="cronograma.php" method="post" class="header-search">
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sql2="select * from appointment where scheduleid=$id";
                                     $result12= $bd->query($sql2);
                                     $apponum=($result12->num_rows)+1;
                                    
                                    echo '
                                        <form action="reserva-completada.php" method="post">
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            ...
                                                            Correo electrónico:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Las citas comienzan: '.$scheduletime.'<br>
                                                             Costo: <b>$$$$</b>
