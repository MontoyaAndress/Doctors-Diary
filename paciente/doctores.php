...
<body>
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Busca a un doctor con su nombre o correo" list="doctors">&nbsp;&nbsp;
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $stmt = $bd->prepare("select sname from specialties where id=?");
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Cédula: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="doctores.php">&times;</a>
                        <div class="content">
                        Quiere ver Todas las sesiones de <br>('.substr($name,0,40).').
