                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No pudimos encontrar nada.</p>
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                                    Fecha de cita: '.substr($appodate,0,30).'<br>
                                                                    Numero de referencia: OC-000-'.$appoid.'
                                                                </div>
                                                                <div class="h1-search">
                                                                ...
                                                                <div class="h4-search">
                                                                    Cita agendada: '.$scheduledate.'<br>Inicia: <b>'.substr($scheduletime,0,5).'</b> (24h)
                                                                </div>
                                                                <br>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>Reservado con éxito.</h2>
                        <a class="close" href="citas.php">&times;</a>
                        <div class="content">
                        Tu número de ficha es: '.$id.'.<br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="citas.php">&times;</a>
                        <div class="content">
                        ¿Quiere cancelar esta cita?<br><br>
                            Cita: &nbsp;<b>'.substr($title,0,40).'</b><br>
                            Doctor&nbsp; : <b>'.substr($docname,0,40).'</b><br><br>
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="eliminar-cita.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Si&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
